...
function RentBox({image, title, rent, onClick, location} : sellProps) {
    return (
        <>
            <div className="w-full h-auto flex justify-between items-start gap-3 py-3 px-3 rounded-md bg-zinc-900">
                ...
                <div className="w-[60%] h-36 flex flex-col justify-start pr-2 items-start">
                    ...
                    <span className="w-full text-start text-white text-[12px] md:text-sm font-light flex justify-start items-center gap-1">₹  {rent}/hr</span>
